...
* Container vs Virtual Machine: Containers are smaller and much more lightweight than a full virtual machine. The container uses only the operating system kernel (this detail is omitted above to ease readability for beginners), and only include select, application-specific files. This saves gigabytes of data, massive amounts of RAM, and decreases load times. "Containers" are designed for "shipment" between devices, not ease of utility (lack of graphic interfaces), or power. 

### Git and Github
I have always been a Git novice. The website section of this project has been done without AI assistance to force me to learn the fundamentals of Git on my own before speeding up the process with agentic tools. So far, I have become much better versed in the Git framework, including staging, commits, and branches. I have also begun to learn the commands for transferring between these areas and pushing to a remote repository (Github). I hope to create and post a full Git tutorial eventually. 
